...
var logger = Logger.create('SimpleMQTTPluginMotion');
var mqtt = require('mqtt');
var HMSECMDIR2_1 = require("../devices/HMSECMDIR2");
var SimpleMQTTPluginMotion = /** @class */ (function () {
    function SimpleMQTTPluginMotion() {
        this.name = 'SimpleMQTTPluginMotion';
        this.devices = [];
        //states and vars
    ...
    SimpleMQTTPluginMotion.prototype.init = function (p) {
        ...
        var device = new HMSECMDIR2_1.HMSECMDIR2(p.deviceName);
...
//    };
    ...
    SimpleMQTTPluginMotion.prototype.mqttPublish = function (mqttTopic, mqttMessage) {
        if (this.mqttAvailable) {
            logger.debug('publish to', mqttTopic, mqttMessage);
            this.mqttConnection.publish(mqttTopic, mqttMessage);
        }
    };
    SimpleMQTTPluginMotion.prototype.mqttSubscribe = function (mqttTopic) {
        if (this.mqttAvailable) {
    ...
    SimpleMQTTPluginMotion.prototype.handleIncommingSubscribedMqttMessage = function (that, topic, message) {
    ...
    return SimpleMQTTPluginMotion;
}());
exports.SimpleMQTTPluginMotion = SimpleMQTTPluginMotion;

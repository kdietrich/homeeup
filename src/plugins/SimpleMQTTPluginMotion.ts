...
const logger = Logger.create('SimpleMQTTPluginMotion');
const mqtt = require('mqtt')
import { PluginInterface } from "./PluginInterface";
import { HMSECMDIR2 } from "../devices/HMSECMDIR2";

export class SimpleMQTTPluginMotion implements PluginInterface {

    name: String = 'SimpleMQTTPluginMotion';
    devices = [];
    ...
    init(p) {
        ...
        let device = new HMSECMDIR2(p.deviceName);

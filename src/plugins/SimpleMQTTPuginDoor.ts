...
const logger = Logger.create('SimpleMQTTPluginDoor');
const mqtt = require('mqtt')
import { PluginInterface } from "./PluginInterface";
import { HMSECSC2 } from "../devices/HMSECSC2";

export class SimpleMQTTPluginDoor implements PluginInterface {

    name: String = 'SimpleMQTTPluginDoor';
    devices = [];
    ...
    init(p) {
        ...
        let device = new HMSECSC2(p.deviceName);
